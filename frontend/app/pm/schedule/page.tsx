...
export default function PMSchedule() {
  const mockActivities = [
    {
      id: '1', projectId: 'p1', activityCode: 'EXC-01', activityName: 'Site Excavation',
      location: { type: 'Point' as const, coordinates: [94.92, 27.47] as [number, number] },
      plannedStart: new Date().toISOString(), plannedEnd: new Date(Date.now() + 86400000).toISOString(),
      percentComplete: 45, status: 'in_progress' as const, keywords: []
    },
    {
      id: '2', projectId: 'p1', activityCode: 'PIP-04', activityName: 'Pipeline Welding Segment A',
      location: { type: 'Point' as const, coordinates: [94.93, 27.46] as [number, number] },
      plannedStart: new Date(Date.now() - 86400000).toISOString(), plannedEnd: new Date().toISOString(),
      percentComplete: 90, status: 'delayed' as const, keywords: []
    }
  ];
